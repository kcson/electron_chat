...
var Rooms = function (_React$Component) {
    ...
    _createClass(Rooms, [{
        ...
        value: function handleOnSubmit(e) {
            ...
            newRoomRef.update(newRoom).then(function () {
                ...
                return _this2.fetchRooms().then(function () {
                    _this2.props.history.push("/rooms/${newRoomRef.key}");
                });
            });
        }
    }, {
        ...
        value: function renderRoomList() {
            ...
            //const {roomId} = this.match.props.params;
        ...
        value: function renderRoom() {
            if (this.props.match.params.roomId) {
                //alert("renderRoom " + this.props.match.params.roomId)
                return _react2.default.createElement(_Room2.default, { roomId: this.props.match.params.roomId });
